...
- **Clinical Safety**: Software aligns with [NHS Digital Technology Assessment Criteria (DTAC)](https://www.digitalregulations.innovation.nhs.uk/regulations-and-guidance-for-developers/all-developers-guidance/using-the-digital-technology-assessment-criteria-dtac/), specifically DCB0129/DCB0160 and data residency requirements.
- **Medical Device Compliance**: Depending on the level of clinical decision support, the software may be classified as a Software as a Medical Device (SaMD) under MHRA guidelines.
